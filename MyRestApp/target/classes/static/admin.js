...
const addUserFormSecondName = document.getElementById("add-user-form-second-name");
...
addUserForm.addEventListener("submit", (e) => {
    ...
    fetch(requestURL, {
        ...
        body: JSON.stringify({
            ...
            secondName: addUserFormSecondName.value,
...
//------------- Удаление юзеров -------------//
    ...
    const deleteUsersSecondName = document.getElementById("delete-secondName")
    ...
    if (delButtonIsPressed) {
        ...
        fetch(requestURL + "/" + currentUserId, {
            ...
            .then(user => {
                ...
                deleteUsersSecondName.value = user.secondName;
...
//------------- Изменение юзеров -------------//
    ...
    const editUsersSecondName = document.getElementById("edit-secondName");
    ...
    if (editButtonIsPressed) {
        ...
        fetch(requestURL + "/" + currentUserId, {
            ...
            .then(user => {
                ...
                editUsersSecondName.value = user.secondName;
        ...
        modalEditSubmitBtn.addEventListener("click", e => {
            ...
            let user = {
                ...
                secondName: editUsersSecondName.value,
